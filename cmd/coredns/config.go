...
const (
	...
	defaultDataDir    = "/var/lib/coredns-incus"
	defaultSecretsDir = "/run/secrets"

	defaultProjectMarker = "user.label.coredns.scope=global"
...
// --project-marker user.coredns is the short way to write the common case.
