...
release tag="v0.0.1-dev0" healthd_image="registry.gitlab.com/r3j0/incus-compose/ic-healthd": build release-healthd-image
    git tag {{ tag }}
    git push --tags
    release-healthd-image {{ healthd_image }}:{{ tag }}
    goreleaser release
